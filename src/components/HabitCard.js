...
const HabitCard = ({ habit, habits, addDate, removeDate, habitSelect, selectedHabit }) => {
    ...
    const habitDays = habit.days.map(day => moment.unix(day.date).format("ddd Do"));
        ...
        <div>
            <Paper style={{ marginTop: "10px", padding: "5px", display: "flex", flexDirection: "row", alignItems: "center", background: "#EFEFEF" }}>
                ...
                <div style={{ width: "125px" }}>
                    ...
                    <Typography variant="h6" style={{ cursor: "pointer", color: "black" }} onClick={() => handleSelect()} >
                        {title}
                    </Typography>
                    </Link>
                </div>
